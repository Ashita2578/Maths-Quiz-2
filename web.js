var player1_name= localStorage.getItem("user_play1");
var player2_name= localStorage.getItem("user_play2");
document.getElementById("user_play1").innerHTML= player1_name;
document.getElementById("user_play2").innerHTML= player2_name;
